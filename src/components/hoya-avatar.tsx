  ...
  if (person.photoUrl) {
    return (
      ...
      <img
        src={person.photoUrl}
        alt=""
        className={`${dim} shrink-0 rounded-full object-cover ring-1 ring-gold/50`}
      />
    );
  }
  return (
    <div
      className={`flex ${dim} shrink-0 items-center justify-center rounded-full bg-navy font-semibold text-gold ring-1 ring-gold/50`}
      aria-hidden
    >
